...
- Não há teste automatizado das políticas de RLS. Como a matriz de permissões agora é dado (e não código), uma suíte que autentique como cada perfil e confira o que ele enxerga seria o próximo passo natural. Os cenários já estão documentados em prosa em `docs/casos-de-teste-permissoes.md`, prontos para virar teste automatizado.
